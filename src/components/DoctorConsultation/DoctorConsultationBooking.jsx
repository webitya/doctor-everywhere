...
export default function DoctorConsultationBooking() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        alert("Doctor consultation booking request sent successfully!")
        setFormData({ name: "", email: "", phone: "", specialty: "general-medicine", date: "", time: "", notes: "" })
      }
    } catch (error) {
    ...
    <section id="booking-section" className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Schedule your appointment with one of our qualified doctors.</p>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-6 max-w-2xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <textarea
              ...
              placeholder="Describe your symptoms or health concerns (optional)"
            />
